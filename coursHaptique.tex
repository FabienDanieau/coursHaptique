...
\date{9 Janvier 2018}%Mise à jour: \today}
...
\titlegraphic{\hfill\includegraphics[height=1cm]{Technicolor_logo.png}}
%--------------------------------------------------------------------------
% Notes settings
%--------------------------------------------------------------------------
...
{
\setbeamertemplate{frame footer}{\cite{weinstein1968}}
\begin{frame}{La perception tactile}
\begin{figure}
\centering
\includegraphics[width=8cm]{images/tactileBody}
\end{figure}
\end{frame}
}
